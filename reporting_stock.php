                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Rate / Foot</th>
                                        <th>Rate of Length</th>
                                        <th>Remaining Lengths</th>
<!--                                        <th>InStock Price</th>-->
                                        <th>Length Size</th>
                                        <th>Width</th>
                                        <th>Wastage</th>
...
if(!$result){
    echo "Unhandled Server Response 500 please report developer";
}
...
echo $list_cust['pid'];
echo '</td><td>';
echo $list_cust['rate_in_feet']."rs / foot";
echo ' </td><td>';
echo $list_cust['rate_of_length'];

$no_length_foot = $list_cust['no_of_length'] / $list_cust['size'] / 12;
$no_length_foot = round($no_length_foot,1);

if( $no_length_foot == 0){
    
echo ' <td  style="color: #ff5d48;font-weight: bolder;background-color: #ff5d48;">';
echo $no_length_foot."  &nbsp &nbsp &nbsp &nbsp<button class='btn btn-danger btn-sm' href='#'>Out of Stock</button>";
echo ' </td>'   ;
} else if( $no_length_foot< 8 ){
echo ' <td  style="color: red;font-weight: bolder;background-color: #ffb1b1;">';
echo $no_length_foot."  &nbsp &nbsp &nbsp &nbsp<button class='btn btn-danger btn-sm' href='#'>Low Stock</button>";
echo ' </td>'   ;
...
//echo '<td>';
//    echo $list_cust['instockp']." Rs";
//echo ' </td>';
    
echo '<td>';
    echo $list_cust['size']." foot";
echo ' </td><td>';
    echo $list_cust['width']." inch";
echo ' </td><td>';
echo $list_cust['wastage']." inch";
    echo ' </td><td>';
echo $list_cust['datetime'];
echo ' </td></tr>';
    ...
    <div class="modal-content">
      ...
      <div style="    padding: 50px 10px 25px 55px;" class="modal-body">
        ...
        <form action="controller/update_stock.php" method="post">
            ...
            <div class="form-group row">
                <label class="col-sm-4 form-control-label">No of Lengths <span class="text-danger"></span></label>
                <div class="col-sm-7">
                    <input type="text" required class="form-control" id="c_name" name="s_no_length" placeholder=""> </div>
            </div>
            
             <div class="form-group row">
                <label class="col-sm-4 form-control-label">Length Size <span class="text-danger"></span></label>
                <div class="col-sm-7">
                    <input type="text" required class="form-control" id="c_name" name="s_size" placeholder=""> </div>
            </div>
             ...
             <div class="form-group row">
              ...
              <div class="form-group row">
                <label class="col-sm-4 form-control-label">Width <span class="text-danger"></span></label>
                <div class="col-sm-7">
...
<!-- Mirrored from coderthemes.com/Sajjad Framers_1.4/horizontal/tables-datatable.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Oct 2016 01:48:35 GMT -->
</html>